const services = [
  {
    title: 'Web Design',
    desc: 'Modern, responsive interfaces that convert and delight.',
    icon: (
  ...
  {
    title: 'Development',
    desc: 'Fast, SEO‑friendly websites and web apps built with best practices.',
    icon: (
  ...
  {
    title: 'Ecommerce',
    desc: 'High‑converting storefronts with flawless checkout experiences.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 3h18l-2 13H5L3 3zm3 16a2 2 0 104 0 2 2 0 00-4 0zm10 0a2 2 0 104 0 2 2 0 00-4 0z" /></svg>
    )
  },
  {
    title: 'Branding',
    desc: 'Clear, consistent visuals that strengthen your identity.',
    icon: (
    ...
    <section id="services" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-gray-600">Design, development and growth for ambitious brands.</p>
        </div>
